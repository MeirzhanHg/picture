...
var modals = function modals(state) {
  ...
  function calcScroll() {
    ...
    var scrollWidh = div.offsetWidth - div.clientWidth;
    div.remove();
    return scrollWidh;
  }
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:5000/styles').then(function (res) {
